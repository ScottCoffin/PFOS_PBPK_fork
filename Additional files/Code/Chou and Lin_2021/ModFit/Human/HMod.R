...
double BW           = 0.0014*pow(WK,2) - 0.1227*WK + BW0;
double VPlasC       = (1E-4)*pow(WK,2) - 0.0024*WK + 0.0469;
double VPlasC_0     = 0.0469;
double VFC          = (-7E-4)*WK + 0.3026;
double VFC_0        = 0.3026;
double VFC_F        = (-7E-4)*48 + 0.3026;
double KMilk_0      = (1E-9)*pow(PND, 3) - (1E-6)*pow(PND, 2) + 0.0002*PND + 0.0211;
double KMilk        = Mon <= 6? KMilk_0: 0;
double VMT          = (-3E-6)*pow(PND, 2) + 0.0006*PND + 0.0059;
double GFR          = 0.0259*pow(WK,2) - 0.4369*WK + 7.7972;
...
double BW_neo       = (-0.0183)*pow(Mon, 2) + 0.7732*Mon + 3.7711;
double Htc_neo      = WK > 27 ? (0.744*WK + 24.656)/100: 0.37;
double VPlasC_neo   = (4E-6)*pow(Yr,3) - 0.0003*pow(Yr,2) + 0.0059*Yr + 0.05; 
